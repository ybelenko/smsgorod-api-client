...
/**
 * @coversDefaultClass \Ybelenko\SmsGorod\BalanceRequest
 */
class BalanceRequestTest extends TestCase{
    ...
    public function testConstructor(
        ...
        $this->assertEquals('http://web.smsgorod.ru/xml/balance.php', BalanceRequest::BALANCE_URL);
        $req = new BalanceRequest($login, $password, $isSilent);
